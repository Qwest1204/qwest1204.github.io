...
* Я взял архитектуру из 16 слоёв с latent attention (окно 64 токена, O(n·k)), двухслойным FFN (2048 hidden, GELU), нормализацией и остатками;
...
#### Алгоритм: 
1. файлы в tarball с 512-бит хешем; 
2. удаляю каждые n байт блок n^2;
3. декомпрессия — маски <|mask|>, генерирую на embeddings не только хеша блока, но и метаданных файла, итеративно до матча хеша. Плюс векторизация для супербыстрого поиска по хешу/имени.
